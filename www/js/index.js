...
function renderTodoElements(todos, flag = false) {
    ...
    filteredTodos
        .forEach(function(todo) {
            ...
            if (!todo.completed) {
                buttonModifyHtmlElement = `<a onclick="modifyTodo(${todo.id})" id="btn-modify-item-${todo.id}" class="btn btn-sm btn-primary enabled"><i class="fa fa-edit"></i> Modify</a>`;
                buttonCompleteHtmlElement = `<a onclick="completeTodo(${todo.id})" id="btn-remove-item-${todo.id}" class="btn btn-sm btn-success enabled"><i class="fa fa-check-circle"></i> Complete</a>`;
            }
            let todoElement = `
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <p>
                            ...
                            <a onclick="removeTodo(${todo.id})" id="btn-delete-item-${todo.id}" class="btn btn-sm btn-danger enabled"><i class="fa fa-eraser"></i> Delete</a>
...
function showEmptyTodoContainer() {
    todoContainer.innerHTML = `<h1>There is no items</h1>`;
}
